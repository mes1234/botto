...
class VisualizerProcessor(BottoProcess[SensorDataMsg]):
    ...
    def run_code(self):
        ...
        self.robot_id = p.loadURDF(self.urdf_file, basePosition=[0, 0, 1.2])
    ...
    def visualize_handler(self, msg: LegAnglesPhaseMsg):
        ...
        for leg_enum, angles_msg in msg.leg_angles.items():
            if leg_enum == LegEnum.FRONT_LEFT:
                ...
                self.joints["fl_knee_to_fl_foot"] = (
                    angles_msg.alfa_3 - angles_msg.alfa_2
                )
                ...
                self.joints["fr_knee_to_fr_foot"] = (
                    angles_msg.alfa_3 - angles_msg.alfa_2
                )
                ...
                self.joints["rl_knee_to_rl_foot"] = (
                    angles_msg.alfa_3 - angles_msg.alfa_2
                )
                ...
                self.joints["rr_knee_to_rr_foot"] = (
                    angles_msg.alfa_3 - angles_msg.alfa_2
                )
        pass
